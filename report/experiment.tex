...
\begin{figure}[t]
\begin{center}
   \includegraphics[width=0.8\linewidth]{./figures/disf.png}
\end{center}
   \caption{Performance of the the random forest classifier using different input data with all features}
\label{fig:diaf}
\end{figure}

Figure~\ref{fig:diaf} shows the binary classification result for using different input data with all features. 
